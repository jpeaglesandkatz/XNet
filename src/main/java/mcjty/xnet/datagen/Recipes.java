...
public class Recipes extends BaseRecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        build(consumer, ShapedRecipeBuilder.shapedRecipe(WirelessRouterModule.ANTENNA.get())
                        ...
                        .addCriterion("bars", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), Items.IRON_BARS)),
                "IiI", "IiI", " i ");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(WirelessRouterModule.ANTENNA_BASE.get())
                        .key('I', Items.IRON_BLOCK)
                        .addCriterion("block", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), Items.IRON_BLOCK)),
                " i ", " i ", "iIi");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(WirelessRouterModule.ANTENNA_DISH.get())
                        .key('I', Items.IRON_TRAPDOOR)
                        .addCriterion("trapdoor", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), Items.IRON_TRAPDOOR)),
                "III", "IoI", " i ");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(VariousModule.REDSTONE_PROXY.get())
                        .addCriterion("frame", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get())),
                "rrr", "rFr", "rrr");
        ...
        build(consumer, ShapedRecipeBuilder.shapedRecipe(FacadeModule.FACADE.get(), 16)
                        .key('w', ItemTags.WOOL)
                        .addCriterion("glass", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), Items.GLASS)),
                "pwp", "wGw", "pwp");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(CableModule.NETCABLE_BLUE.get(), 16)
                        ...
                        .addCriterion("nugget", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), Items.GOLD_NUGGET)),
                "s1s", "rgr", "srs");
        ...
        build(consumer, ShapedRecipeBuilder.shapedRecipe(CableModule.CONNECTOR_BLUE.get())
                        ...
                        .addCriterion("chest", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), Items.CHEST)),
                "1C1", "rgr", "1r1");
        ...
        build(consumer, new ResourceLocation(XNet.MODID, "redstoneproxy_update"), ShapelessRecipeBuilder.shapelessRecipe(VariousModule.REDSTONE_PROXY_UPD.get())
                ...
                .addCriterion("torch", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousModule.MACHINE_FRAME.get(), Items.REDSTONE_TORCH)));

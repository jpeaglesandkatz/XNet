...
public class Recipes extends BaseRecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        build(consumer, ShapedRecipeBuilder.shapedRecipe(WirelessRouterSetup.ANTENNA.get())
                        ...
                        .addCriterion("bars", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get(), Items.IRON_BARS)),
                "IiI", "IiI", " i ");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(WirelessRouterSetup.ANTENNA_BASE.get())
                        .key('I', Items.IRON_BLOCK)
                        .addCriterion("block", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get(), Items.IRON_BLOCK)),
                " i ", " i ", "iIi");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(WirelessRouterSetup.ANTENNA_DISH.get())
                        .key('I', Items.IRON_TRAPDOOR)
                        .addCriterion("trapdoor", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get(), Items.IRON_TRAPDOOR)),
                "III", "IoI", " i ");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(VariousSetup.REDSTONE_PROXY.get())
                        .addCriterion("frame", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get(), mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get())),
                "rrr", "rFr", "rrr");
        ...
        build(consumer, ShapedRecipeBuilder.shapedRecipe(FacadeSetup.FACADE.get(), 16)
                        .key('w', ItemTags.WOOL)
                        .addCriterion("glass", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get(), Items.GLASS)),
                "pwp", "wGw", "pwp");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(CableSetup.NETCABLE_BLUE.get(), 16)
                        ...
                        .addCriterion("nugget", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get(), Items.GOLD_NUGGET)),
                "s1s", "rgr", "srs");
        ...
        build(consumer, new ResourceLocation(XNet.MODID, "redstoneproxy_update"), ShapelessRecipeBuilder.shapelessRecipe(VariousSetup.REDSTONE_PROXY_UPD.get())
                ...
                .addCriterion("torch", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolsbase.modules.various.VariousSetup.MACHINE_FRAME.get(), Items.REDSTONE_TORCH)));
